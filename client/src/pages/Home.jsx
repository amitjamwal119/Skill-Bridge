    ...
    <div className="home-container">
      ...
      <div className="containerr">
        <div className="containerr-1">
          <h5>Our Partner Universities</h5>
          <div className="cards">
            <div className="card" onClick={() => handleUniversityClick(1)}>
              <img 
              ...
              <div className="card-body">
                ...
                <p className="card-text">Master Data Analytics at Sheffield Hallam University</p>
                <button className="card-button">Learn More</button>
              </div>
            </div>
            <div className="card" onClick={() => handleUniversityClick(2)}>
              <img 
              ...
              <div className="card-body">
                ...
                <p className="card-text">Excel in IT Management at University of Melbourne</p>
                <button className="card-button">Learn More</button>
              </div>
            </div>
            <div className="card" onClick={() => handleUniversityClick(3)}>
              <img 
              ...
              <div className="card-body">
                ...
                <p className="card-text">Advance your Computing skills at University of Toronto</p>
                <button className="card-button">Learn More</button>
              </div>
            </div>
          </div>
