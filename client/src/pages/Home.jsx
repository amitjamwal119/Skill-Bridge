...
import { Autoplay, Pagination, EffectFlip, EffectCoverflow } from "swiper/modules";
import 'swiper/css';
...
const Home = () => {
 ...
 <div className="top-div">
      ...
      {/* Swiper start */}
      <div className="slide-outer mt-3">
          ...
          >
            {
              courses.map((course, index) => (
                <SwiperSlide key={index} className='slide'>
                  <img src={course.image} alt={course.title} className='slider-img' />
